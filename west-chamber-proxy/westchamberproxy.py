...
import os, re, socket, struct, threading, traceback, sys, select, urlparse, signal, urllib, urllib2, time, hashlib, binascii, zlib, httplib, BaseHTTPServer, errno, ConfigParser
try:
    import OpenSSL
except ImportError:
    OpenSSL = None
